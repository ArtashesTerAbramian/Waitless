        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_coffee_beverage_size_beverage_size_id",
                        column: x => x.beverage_size_id,
                        principalTable: "coffee_size",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_coffee_coffee_types_beverage_type_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    beverage_type_id = table.Column<long>(type: "bigint", nullable: false),
                    name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    created_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    modify_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    is_deleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_coffee_type_translation_coffee_type_beverage_type_id",
                        column: x => x.beverage_type_id,
                        principalTable: "coffee_type",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_coffee_photo_coffee_beverage_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_coffee_translation", x => new { x.language_id, x.beverage_id });
                    table.ForeignKey(
                        name: "fk_coffee_translation_coffee_beverage_id",
                        column: x => x.beverage_id,
                        principalTable: "coffee",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_coffee_beverage_type_id_beverage_size_id",
                table: "coffee",
                columns: new[] { "beverage_type_id", "beverage_size_id" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_coffee_photo_beverage_id",
                table: "coffee_photo",
                column: "beverage_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_coffee_translation_beverage_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_coffee_type_translation_beverage_type_id_language_id",
                table: "coffee_type_translation",
                columns: new[] { "beverage_type_id", "language_id" });

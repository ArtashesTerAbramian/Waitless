...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Waitless.DAL.Models.Coffee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Waitless.DAL.Models.CoffeePhoto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Waitless.DAL.Models.CoffeeTranslation", b =>
                {
                    b.Property<int>("LanguageId")
                        .HasColumnType("integer")
                        .HasColumnName("language_id");
            ...
            modelBuilder.Entity("Waitless.DAL.Models.CoffeeType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Waitless.DAL.Models.CoffeeTypeTranslation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Waitless.DAL.Models.Coffee", b =>
                {
                    ...
                    b.HasOne("Waitless.DAL.Models.CoffeeType", "CoffeeType")
                        .WithMany()
                        .HasForeignKey("CoffeeTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_coffee_coffee_types_coffee_type_id");

                    b.HasOne("Waitless.DAL.Models.Order", null)
                        .WithMany("Coffees")
            ...
            modelBuilder.Entity("Waitless.DAL.Models.CoffeePhoto", b =>
                {
                    b.HasOne("Waitless.DAL.Models.Coffee", "Coffee")
                        .WithMany("Files")

...
//     }
//
//     public async Task<PagedResult<List<CoffeeTypeDto>>> GetAll(BeverageTypeFilter filter)
//     {
...
//
//         return new PagedResult<List<CoffeeTypeDto>>(await filter.GetPagedInfoAsync(query), types.MapToBeverageTypesDtos());
//     }
//     
